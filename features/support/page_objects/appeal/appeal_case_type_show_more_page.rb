class AppealCaseTypeShowMorePage < BasePage
  ...
  section :content, '#main-content' do
    element :header, 'h1', text: I18n.t('dictionary.CASE_TYPE_QUESTION.heading') 'What is your appeal about?'
    element :aggregates_levy_option,'.govuk-label', text: I18n.t('check_answers.case_type.answers')
