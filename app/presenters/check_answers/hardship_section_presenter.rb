  ...
  class HardshipSectionPresenter < SectionPresenter
    ...
    def answers
      [
        ...
        Answer.new(:hardship_review_requested, tribunal_case.hardship_review_requested,
                   change_path: edit_steps_hardship_hardship_review_requested_path),
        Answer.new(:hardship_review_status, tribunal_case.hardship_review_status,
                   change_path: edit_steps_hardship_hardship_review_status_path),
        FileOrTextAnswer.new(:hardship_reason, tribunal_case.hardship_reason, tribunal_case.documents(:hardship_reason).first,
                             change_path: edit_steps_hardship_hardship_reason_path)
      ].select(&:show?)
    end
  end
end
