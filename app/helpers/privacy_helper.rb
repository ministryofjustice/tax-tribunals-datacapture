module PrivacyHelper
  def call_charges_link
    link_to(t('privacy.call_charges'), 'https://www.gov.uk/call-charges',
      target: '_blank',
  ...
  def moj_personal_character_link
    link_to(
      t('privacy.who_managing.personal_character'),
  ...
  def terms_link
    link_to(t('privacy.terms'), terms_page_path, target: '_blank', title: t('privacy.terms'))
  end

  def how_we_use_link
    link_to(t('privacy.how_we_use.header'), '#how_we_use', title: t('privacy.how_we_use.header'))
  end
  ...
  def how_to_access_link
    link_to(t('privacy.how_to_access.header'), "#how_to_access",
  ...
  def cookies_page_link
    link_to t('privacy.cookies.cookie'), cookies_page_path,
      target: '_blank',
